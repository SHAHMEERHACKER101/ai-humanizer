 ...
 * Production-ready, supports offline & PWA functionality
 */

const CACHE_NAME = 'nexusrank-pro-v2.1.0';
const API_CACHE_NAME = 'nexusrank-api-v2.1.0';
...
console.log('[SW] Service Worker v2.1.0 loaded and ready');
